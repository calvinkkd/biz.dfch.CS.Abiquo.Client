...
namespace biz.dfch.CS.Abiquo.Client.v1
{
    public abstract class AbiquoMediaDataTypes
    {
        ...
        public static string VND_ABIQUO_USERSWITHROLESDTO = string.Format(VERSION_TEMPLATE, "application/vnd.abiquo.userswithrolesdto", AbiquoClient.ABIQUO_API_VERSION);
        ...
        public static string VND_ABIQUO_VIRTUALDATACENTERDTO = string.Format(VERSION_TEMPLATE, "application/vnd.abiquo.virtualdatacenterdto", AbiquoClient.ABIQUO_API_VERSION);
